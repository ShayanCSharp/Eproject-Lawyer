    ...
    <div class="sidebar sidebar__right">
        ...
        <div class="sidebar__single">
            <div class="sidebar__cta">
                <h3 class="sidebar__cta-title">Lorem Ipsum Dolor Amet</h3><!-- /.sidebar__cta-title -->
                <p class="sidebar__cta-text">Sit amet consectetur adipisicing elit eor incididuynt uet labore.</p><!-- /.sidebar__cta-text -->
                <a href="contact.php" class="thm-btn sidebar__cta-btn">get in touch <i class="fas fa-long-arrow-alt-right"></i></a>
            </div><!-- /.sidebar__cta -->
        </div><!-- /.sidebar__single -->
        <div class="sidebar__single">
